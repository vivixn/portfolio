var points = [
 ...
 for(var i=0; i<points.length; i++){
    var fruitDiv = $('<div/>', {
      ...
      .hover(function(){
        $(this).css({'opacity': .95 , 'backgroundColor': 'peach'})
        .html(
        points[i].pic
